...
C. Final Prompt (V3): You are an expert teacher who explains difficult concepts to children. Explain neural networks to a 10-year-old using simple words, a real-life example, and an analogy. Avoid technical jargon and keep the explanation under 200 words.
